...
BootCaptain adds: human review is mandatory for helper, XPC, mutation,
authorization, entitlement, signing, and release changes. GLM review is an
additional signal, not approval.
